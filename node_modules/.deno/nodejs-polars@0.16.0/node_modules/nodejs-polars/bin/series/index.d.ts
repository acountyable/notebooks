...
import type { DTypeToJs, DtypeToJsName, JsToDtype, JsType } from "../datatypes/datatype";
import type { Arithmetic, Comparison, Cumulative, Deserialize, EwmOps, Rolling, Round, Sample, Serialize } from "../shared_traits";
 ...
 */
export interface Series<T extends DataType = any> extends ArrayLike<T>, Rolling<Series<T>>, Arithmetic<Series<T>>, Comparison<Series<T>>, Cumulative<Series<T>>, Round<Series<T>>, Sample<Series<T>>, EwmOps<Series<T>>, Serialize {
    inner(): any;
    name: string;
    dtype: T;
    str: StringNamespace;
     ...
     * ```
     */
    valueCounts(sort?: boolean, parallel?: boolean, name?: string, normalize?: boolean): DataFrame;
    /**
...
export interface SeriesConstructor extends Deserialize<Series> {
     ...
     * ```
     */
    <T1 extends JsType>(name: string, values: ArrayLike<T1>): Series<JsToDtype<T1>>;
    <T2 extends DataType>(name: string, values: ArrayLike<DTypeToJs<T2>>, dtype?: T2): Series<T2>;
    ...
    from<T2 extends JsType>(name: string, arrayLike: ArrayLike<T2>): Series<JsToDtype<T2>>;
