...
export interface DataFrame extends Arithmetic<DataFrame>, Sample<DataFrame>, Arithmetic<DataFrame>, WriteMethods, Serialize, GroupByOps<RollingGroupBy> {
     ...
     */
    sort(by: ColumnsOrExpr, descending?: boolean, nulls_last?: boolean, maintain_order?: boolean): DataFrame;
  ...
  └────────────┴────────┴────────┘
    */
    upsample(timeColumn: string, every: string, by?: string | string[], maintainOrder?: boolean): DataFrame;
    upsample(opts: {
        timeColumn: string;
        every: string;
        by?: string | string[];
